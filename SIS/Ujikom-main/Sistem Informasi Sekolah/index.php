           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=data"><i class="fa fa-paper-plane fa-2x"></i> Data Siswa</a></li>
					<li><a href="index.php?halaman=data"><i class="fa fa-paper-plane fa-2x"></i> Data Guru</a></li>
